...
public class UserInfoApp {
    public static void main(String[] args) {
        ...
        System.out.println("Введите ваши данные (Фамилия, Имя, Отчество, Дата рождения, Номер телефона, Пол): ");
        ...
        try {
            ...
            System.err.println("Ошибка: Неправильный формат даты. Пожалуйста, вводите в формате "dd.MM.yyyy");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private static long parsePhoneNumber(String phoneNumberStr) {
        try {
            ...
            throw new IllegalArgumentException("Неправильный формат введения телефонного номера.");
        }
    }
...
genderStr.equalsIgnoreCase("m"))) {
            throw new IllegalArgumentException("Неправильный формат введения пола. Ожидается 'f' или 'm'.");
        }
